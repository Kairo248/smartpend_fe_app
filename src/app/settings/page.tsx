        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => updateSetting('profile', 'currency', e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
            ...
            <div key={key} className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  ...
                  {key === 'expenseReminders' && 'Daily reminders to log your expenses'}
                  {key === 'weeklyReports' && 'Weekly spending summaries via email'}
                  {key === 'monthlyReports' && 'Monthly financial reports and insights'}
                </p>
              </div>
        ...
        <div className="space-y-4">
          {Object.entries(settings.privacy).map(([key, value]) => (
            <div key={key} className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-900">
                  {key === 'shareAnalytics' ? 'Share Anonymous Analytics' : 'Two-Factor Authentication'}
                </p>
                <p className="text-sm text-gray-500">
                  {key === 'shareAnalytics' 
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="grid grid-cols-1 lg:grid-cols-4">
              {/* Sidebar */}
              <div className="bg-gray-50 rounded-l-lg p-6">
